...
public class AppointmentDAO {
    ...
    // Método para guardar una cita en la base de datos
    ...
    // Método para eliminar una cita por doctor y fecha
    ...
    public List<String> getAvailableDoctors() {
        ...
        String sql = "SELECT nombre FROM Doctors";  // Ajusta el nombre de la tabla y columna según tu esquema
        try (Connection conn = DatabaseConnector.connect();
             PreparedStatement pstmt = conn.prepareStatement(sql);
             ResultSet rs = pstmt.executeQuery()) {
