...
public class AppointmentController {
    ...
    public void initialize() {
        // Cargar médicos disponibles en el ComboBox de forma dinámica
        loadDoctors();
    }

    private void loadDoctors() {
        // Aquí puedes cargar los médicos desde la base de datos, por ejemplo:
    ...
    private void handleRequestAppointment() {
        ...
        if (selectedDoctor != null && !datetime.isEmpty()) {
            ...
            if (isValidDateTime(datetime)) {
                // Crear una nueva cita y guardarla en la base de datos a través de AppointmentDAO
    ...
    private boolean isValidDateTime(String datetime) {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"); // Ajusta el formato según tu necesidad
