...
public class LoginController {
    ...
    private void cargarVistaPrincipal() throws IOException {
        // Cargar la vista principal (asegurarse de que la ruta sea correcta)
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/MainView.fxml"));
        Parent mainView = loader.load();

        // Aquí puedes pasar datos al controlador de la vista principal si es necesario
        // Por ejemplo, si deseas pasar el nombre del usuario logueado:
        // MainController mainController = loader.getController();
        // mainController.setUsuario(usernameField.getText());

        // Mostrar la nueva escena
        Stage stage = (Stage) usernameField.getScene().getWindow();
        stage.setScene(new Scene(mainView, 600, 400));  // Ajusta el tamaño según lo necesites
        stage.show();
    }
}
