...
public class Administrador extends Usuario {
    ...
    public void generarReportes(List<String> datos) {
        // Lógica para generar reportes basados en los datos
        ...
        for (String dato : datos) {
            System.out.println(dato); // Este es un ejemplo simple de reporte
        }
    }

    public void gestionarUsuarios(List<Usuario> usuarios, String accion, Usuario usuario) {
        // Lógica para gestionar usuarios: añadir, modificar, eliminar
