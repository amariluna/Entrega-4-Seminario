...
public class Usuario {
    ...
    public void cambiarContraseña(String nuevaContraseña) {
        // Se podría aplicar un proceso de validación adicional antes de cambiarla
    ...
    public boolean validarContraseña(String contraseña) {
        // Aquí podrías aplicar un algoritmo de hashing para la validación
