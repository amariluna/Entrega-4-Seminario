...
public class Medico extends Usuario {
    ...
    public void actualizarInformacionPaciente(Paciente paciente) {
        // Aquí podrías implementar la lógica para actualizar datos del paciente
    ...
    public void notificarTurno(Paciente paciente, Turno turno) {
        // Este ejemplo muestra un mensaje simple, podrías mejorar la notificación con un sistema de mensajería
