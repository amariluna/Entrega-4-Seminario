...
public class Appointment implements Comparable<Appointment> {
    ...
    public Appointment(String doctor, String datetime) {
        this.doctor = doctor;
        setDatetime(datetime); // Usar el setter para parsear y validar la fecha
    }
    ...
    // Método toString para representar la cita de manera más legible
    @Override
    public String toString() {
        return "Cita con Dr(a). " + doctor + " el " + datetime.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));
    }

    // Método equals para comparar dos citas
    @Override
    ...
    // Implementación del método compareTo para ordenar las citas por fecha
    @Override
